# Security Specification: SinGlutenpzo (Oriven) POS / Inventory System
...
```json
{
  "productName": "Premix Brownie Sin Gluten",
  "productId": "premix_brownie",
  "category": "mezclas",
  "quantity": -2,
  "salePrice": 8.00,
  "profit": 3.00,
...
```json
{
  "productName": "Harina de Coco 1kg",
  "productId": "harina_coco_1kg",
  "category": "harinas",
  "quantity": 1,
  "salePrice": 10.00,
  "profit": 2.50,
...
`id: "harina_coco_1kg_very_long_garbage_key_to_cause_huge_index_bloat_abcdefghijklmnopqrstuvwxyz1234567890abcdefghijklmnopqrstuvwxyz1234567890"`
...
```json
{
  "description": "Pago de Alquiler Local",
  "amount": -250.00,
  "date": "2026-08-10",
  "month": "2026-08",
  "category": "alquiler"
...
describe("SinGlutenpzo Security Rules Validation", () => {
