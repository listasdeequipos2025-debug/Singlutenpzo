                ...
                <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 14px;">
                  ...
                  <tbody>
                    ${items && Array.isArray(items) && items.length > 0
                      ? items.map((it: any) => `
                        <tr style="border-bottom: 1px solid #f1f5f9; color: #334155;">
                          <td style="padding: 12px 0;"><strong>${it.productName}</strong></td>
                          <td style="padding: 12px 0; text-align: center;">${it.quantity}</td>
                          <td style="padding: 12px 0; text-align: right;">$${(it.salePrice || 0).toLocaleString()}</td>
                          <td style="padding: 12px 0; text-align: right; font-weight: bold;">$${((it.salePrice || 0) * (it.quantity || 1)).toLocaleString()}</td>
                        </tr>
                      `).join('')
                      : `
                        <tr style="border-bottom: 1px solid #f1f5f9; color: #334155;">
